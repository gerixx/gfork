...
public class ForkTest {
	...
	public void testSimpleMethod() throws Exception {
		...
		Date date = new Date();
		Fork<Task02, Date> f = new Fork<Task02, Date>(
				new Task02(date), 
				Task02.class.getMethod("getDate"));
	...
	public void testMethodWithArgsAndReturnValue() throws Exception {
		...
		Fork<Task02, Date> f = new Fork<Task02, Date>(
				new Task02(null), 
				Task02.class.getMethod("getDate", When.class), 
				When.TOMORROW);
	...
	public void testMethodWithPrimitiveArgOverload01() throws Exception {
		...
		Fork<Task02, Date> f = new Fork<Task02, Date>(
				new Task02(null), 
				Task02.class.getMethod("getValue", Integer.class), 
				100);
	...
	public void testMethodWithPrimitiveArgOverload02() throws Exception {
		...
		Fork<Task02, Date> f = new Fork<Task02, Date>(
				task, 
				task.getClass().getMethod("getValue", int.class), 
				100);
	...
	public void testMethodPrimitiveArgs() throws Exception {
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", int.class), 
				100);
		f.execute();
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", short.class), 
				(short)100);
		f.execute();
		assertTestPrimitiveArgs(f);
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", long.class), 
				100);
		f.execute();
		assertTestPrimitiveArgs(f);
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", boolean.class), 
				true);
		f.execute();
		assertTestPrimitiveArgs(f);
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", char.class), 
				'a');
		f.execute();
		assertTestPrimitiveArgs(f);
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", byte.class), 
				(byte)255);
		f.execute();
		assertTestPrimitiveArgs(f);
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", double.class), 
				3.14);
		f.execute();
		assertTestPrimitiveArgs(f);
		...
		f = new Fork<Task01, Boolean>(
				task, 
				task.getClass().getMethod("set", float.class), 
				(float)3.14);
		f.execute();
		assertTestPrimitiveArgs(f);
	}
	...
	public void testMethodWithNullReturnValue() throws Exception {
		...
		Fork<Task01, String> f = new Fork<Task01, String>(
				new Task01(), 
				Task01.class.getMethod("getNullValue"));
	...
	public void testKillFork() throws Exception {
		...
		Fork<Task02, Void> f1 = new Fork<Task02, Void>(
				new Task02(null, "f1"), 
				Task02.class.getMethod("endless"));
		Fork<Task02, Void> f2 = new Fork<Task02, Void>(
				new Task02(null, "f2"), 
				Task02.class.getMethod("endless"));
		Fork<Task02, Void> f3 = new Fork<Task02, Void>(
				new Task02(null,"f3"), 
				Task02.class.getMethod("endless"));
	...
	public void testTaskException() throws Exception {
		Fork<Task02, Void> f = new Fork<Task02, Void>(
				new Task02(), 
				Task02.class.getMethod("exception"));
		f.execute();
		f.waitFor();
	...
	public void testJvmOptions() throws Exception {
		...
		Fork.setJvmOptionsForAll(new String[] {
				"-Xmx50m",
				"-Dlibrary.path=" + libdrive,
		});
		Fork<Task01, Boolean> f = new Fork<Task01, Boolean>(
				new Task01(), 
				Task01.class.getMethod("checkLibPath", String.class), 
				libdrive);
		f.execute();
	...
	public void testSystemProperties() throws Exception {
		...
		System.setProperty("customSysProperty2", "xxxxxxx"); // overriden by JVM option, see below
		System.setProperty("customSysProperty3", "xxxxxxx"); // overriden by JVM option for all forks, see below
		...
		Fork<Task01, Boolean> f = new Fork<Task01, Boolean>(
				...
				new Serializable[] { // wrap varargs in a serializable array
					new KeyValue[] {
							new KeyValue("customSysProperty1", "4testonly"),
	...
	public void testStdOutFile() throws Exception {
		...
		Fork<Task02, Void> f = new Fork<Task02, Void>(
				new Task02(), 
				Task02.class.getMethod("printToStdOut"));
	...
	public void testWorkingDir() throws Exception {
		...
		Fork<Task01, String> f = new Fork<Task01, String>(
				new Task01(), 
				Task01.class.getMethod("getWorkingDir"));
	...
	public void testNotifyWithAnonymous() throws Exception {
		...
		Fork<Task02, String> f = new Fork<Task02, String>(
				new Task02(), 
				Task02.class.getMethod("delay", int.class), 
				100);
		...
		Fork.Listener<Task02, String> listener = new Fork.Listener<Task02, String>() {
			...
			@Override
			public void onError(Fork<Task02, String> fork)
					throws IllegalAccessException, InterruptedException {
				fail(fork.getStdErr());
			}
	...
	public void printTaskEnv() throws Exception {
		...
		Fork<Task01, Void> f = new Fork<Task01, Void>(
				new Task01(), 
				Task01.class.getMethod("printEnv"));
	...
	public void negativeMethodWithReturnTypeVoid() throws Exception {
		...
		Fork<Task01, Void> f = new Fork<Task01, Void>(
				new Task01(), 
				Task01.class.getMethod("voidMethod"));
	...
	public void negativeUnknownMethod() throws Exception {
		...
		Fork<Task02, Void> f = new Fork<Task02, Void>(
				new Task02(null), 
				Task02.class.getMethod("methodNotExists"));
	...
	public void negativeInvalidMethodArgs() throws Exception {
		...
		Fork<Task02, Date> f = new Fork<Task02, Date>(
				new Task02(null), 
				Task02.class.getMethod("getDate", String.class), 
				"invalid param");
	...
	private void assertTestPrimitiveArgs(Fork<Task01, Boolean> f) throws InterruptedException,
